<div class="w3-bar w3-padding" id="myNavbar">
    ...
    <a href="faq" class="w3-bar-item w3-button w3-hide-small kel-hover w3-hover-theme-dark w3-round w3-right"><i class="fa fa-question-circle"></i> FAQs</a>
    
    <a href="aboutus" class="w3-bar-item w3-button w3-hide-small kel-hover w3-hover-theme-dark w3-round"><i class="fa fa-users"></i> About us</a>
    ...
    <a href="register" class="w3-bar-item w3-button w3-hide-small kel-hover w3-hover-theme-dark w3-round w3-right"><i class="fa fa-user-plus"></i> Register</a>
    
</div>
    
<div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-animate-top">
    <a href="register" class="w3-bar-item w3-button w3-theme-l1 w3-hover-theme-dark kel-hover-2" onclick="toggleFunction()"><i class="fa fa-user-plus"></i> Register</a>
    <a href="faq" class="w3-bar-item w3-button w3-theme-l1 w3-hover-theme-dark kel-hover-2" onclick="toggleFunction()"><i class="fa fa-question-circle"></i> FAQs</a>
    <a href="aboutus" class="w3-bar-item w3-button w3-theme-l1 w3-hover-theme-dark kel-hover-2" onclick="toggleFunction()"><i class="fa fa-users"></i> About us</a>
